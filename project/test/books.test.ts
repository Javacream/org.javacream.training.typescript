...
describe("books application works", () => {
    it("can create a book", () => {
        const book:Book = new BookClass("ISBN1", "Title1", 19.99, true)
        expect(book).toBeDefined()
    })

    it("description is optional", () => {
        const b1:Book = {isbn: "", title: "", price: 19.99, available: true}
        const b2:Book = {isbn: "", title: "", price: 19.99, available: true, description: "..."}
